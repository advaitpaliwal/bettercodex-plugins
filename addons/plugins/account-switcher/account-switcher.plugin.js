...
module.exports = class AccountSwitcher {
  ...
  async start() {
    ...
    this.root.innerHTML = [
      '<button type="button" class="bc-account-switcher-button" aria-label="Open Account Switcher">',
      '<span class="bc-account-switcher-mark">AS</span>',
      '<span>Accounts</span>',
      '</button>',
      '<div class="bc-account-switcher-panel" hidden></div>',
    ].join("");
  ...
  css() {
    return [
      ".bc-account-switcher-root{position:fixed;right:18px;bottom:18px;z-index:2147483646;font:inherit;color:var(--color-token-foreground,inherit)}",
      ".bc-account-switcher-button{display:flex;align-items:center;gap:8px;height:34px;border:1px solid var(--color-token-border-default,#ffffff24);border-radius:999px;background:var(--color-token-main-surface-primary,#181818);color:inherit;padding:0 12px;box-shadow:0 12px 36px #00000040;cursor:pointer}",
      ...
      ".bc-account-switcher-panel{position:absolute;right:0;bottom:44px;width:min(420px,calc(100vw - 36px));max-height:min(620px,calc(100vh - 90px));overflow:auto;border:1px solid var(--color-token-border-default,#ffffff24);border-radius:16px;background:var(--color-token-main-surface-primary,#181818);box-shadow:0 20px 60px #00000066;padding:14px}",
